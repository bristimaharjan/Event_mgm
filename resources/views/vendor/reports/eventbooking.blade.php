...
<div class="max-w-7xl mx-auto mt-10 ml-72 mr-10">
    <div class="bg-white rounded-2xl shadow-lg p-6">
        ...
        <!-- Date Filter Form -->
        <form method="GET" action="{{ route('vendor.reports.eventbooking') }}" class="mb-4 flex items-center space-x-4">
            <div>
           ...
           <!-- Filter Button -->
                <div class="self-end">
                    ...
                    <!-- Reset Button -->
    <a href="{{ route('vendor.reports.eventbooking') }}" class="px-4 py-2 bg-gray-300 hover:bg-gray-400 rounded text-sm font-medium">
        Reset
    </a>
                </div>
        </form>
